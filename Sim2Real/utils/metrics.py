...
class Metrics(object):
    ITEMS = [{
        ...
        'name': 'DCD',
        'enabled': True,
        'eval_func': 'cls._get_density_aware_chamfer_distance',
        'eval_object': DensityAwareChamferDistance(ignore_zeros=True),
        'is_greater_better': False,
        'init_value': 32767
    }]
    ...
    @classmethod
    def _get_density_aware_chamfer_distance(cls, pred, gt):
        chamfer_distance = cls.ITEMS[-1]['eval_object']
